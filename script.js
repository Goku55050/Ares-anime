...
function setupNextEpisode(anime, episodeId){
    const eps = anime.episodes.map(e=>e.id);
    ...
    if(idx>=0 && idx < eps.length-1){
        ...
        btn.href="watch.html?id="+anime.id+"&ep="+nextId;
        document.querySelector('.watch-player')?.appendChild(btn);
    }
}
